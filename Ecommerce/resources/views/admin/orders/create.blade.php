...
@section('title', 'Create Order - E-commerce Backoffice')

@section('page-title', 'Create Order')

@section('page-description', "Create a new order manually.")
    ...
    <form action="{{ route('orders.store') }}" method="POST" class="mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="number" step="0.01" name="totalPrice" id="totalPrice" class="form-control"
